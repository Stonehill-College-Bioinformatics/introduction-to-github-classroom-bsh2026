...
#for(n in 1:9){
#  if(){
#    grade_tags[n] = "Excellent"
 # }
  #for (n in 1:9) {
 #   if (>90){
   #   grade_tags[n>90]= "Excellent"
#grades <- c(91, 77, 68, 65, 89, 72, 85, 90, 80)
#n=grades[n>90]
#for(n in 1:9) { 
#if (grades[n]>90) {
...
#grades <- c(91, 77, 68, 65, 89, 72, 85, 90, 80)
#grade_tags <- if grade_tags> 90 "Excellent"

grades <- c(91, 77, 68, 65, 89, 72, 85, 90, 80)
grade_tags<- ifelse(grades>90,"Excellent", ifelse(grades>=80 & grades <=90, "Good", "Fair")
)
grade_tags
